    ...
    return (
        <div className="fixed left-0 top-0 z-[100]">
            <div className="h-[100vh] flex relative">
                ...
                <div className={`${expand ? 'translate-x-0' : '-translate-x-[95%]'} absolute w-[18rem] top-0 left-12 transition ease-in duration-300 h-full pt-12 p-3 bg-white border-r border-neutral-300 `}>
