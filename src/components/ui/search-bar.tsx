...
export const SearchBar = () => {
    return (
        <div className="w-full h-9 z-50 flex items-center rounded-md bg-offwhite pl-3 outline outline-1 -outline-offset-1 outline-hairline_dark has-[input:focus-within]:outline has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-2 has-[input:focus-within]:outline-theme-900">
